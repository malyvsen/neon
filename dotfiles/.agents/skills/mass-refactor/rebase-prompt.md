Rebase your branch onto `mass-refactor`. Make sure the resulting history is clean - the repo should pass automated checks after each individual commit you made.
