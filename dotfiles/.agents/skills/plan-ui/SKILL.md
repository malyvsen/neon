---
name: plan-ui
description: Plans UI changes by creating an interactive mockup of the proposed interface, then writing an implementation plan. Use when planning UI changes, creating UI mockups, or designing visual updates.
